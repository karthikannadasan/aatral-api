...
@Entity
@Table(name = "team_push_notify_settings", uniqueConstraints = {
...
public class TeamPushNotifySetting {

	public TeamPushNotifySetting() {
	...
	public String toString() {
		return "TeamPushNotifySetting [id=" + id + ", teamId=" + teamId + ", action=" + action + ", lead=" + lead
